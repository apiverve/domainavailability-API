# Domain Availability Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:domainavailability-api:1.1.12'
}
```
...
```java
import com.apiverve.domainavailability.DomainAvailabilityAPIClient;
import com.apiverve.domainavailability.APIResponse;
import com.apiverve.domainavailability.APIException;

// Initialize the client
DomainAvailabilityAPIClient client = new DomainAvailabilityAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/domainavailability](https://docs.apiverve.com/ref/domainavailability)
...
- **Documentation:** [https://docs.apiverve.com/ref/domainavailability](https://docs.apiverve.com/ref/domainavailability)
- **Issues:** [GitHub Issues](https://github.com/apiverve/domainavailability-api/issues)
